  ...
  async fetch(request, env) {
    ...
    try {
      ...
      if (leadMatch && request.method === "PATCH") {
        ...
        await createEvent(env, leadId, "lead_status_updated", {
          status
        });
        return json({
          success: true,
...
// .wrangler/tmp/bundle-daxAKy/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-daxAKy/middleware-loader.entry.ts
